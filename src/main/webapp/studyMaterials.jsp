...
<body>
	<div>
		...
		<table>
			...
			<tbody>
				<tr>
					<td><a href="studyMaterials/javaMcqQuestions.pdf"><img
							alt="java image" src="./images/javaPdfImage.jpg"
							class="imgalignment"></a></td>
					<td><a href="studyMaterials/htmlMcqQuestions.pdf"><img
							alt="html image" src="./images/htmlPdfImage.jpg"
							class="imgalignment"></a></td>
					<td><a href="studyMaterials/cssMcqQuestions.pdf"><img
							alt="css image" src="./images/cssPdfImage.png"
							class="imgalignment"></a></td>
				</tr>
				<tr>
					<td></td>
					<td><a href="studyMaterials/pythonMcqQuestions.pdf"><img
							alt="python image" src="./images/pythonPdfImage.png"
							class="imgalignment py"></a></td>
				</tr>
			</tbody>
		</table>
</body>
